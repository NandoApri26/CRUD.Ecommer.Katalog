...
public class BarangController : Controller
{
    ...
    public BarangController(ILogger<BarangController> logger, Db_MarketContext dbContext)
    {
    ...
    public IActionResult Create(BarangRequest brg)
    {
        ...
        var dataUser = int.Parse(User.Claims.First(x => x.Type == "Id").Value);
        var penjual = _dbContext.Penjuals.First(x => x.IdUser == dataUser);
